...
<?php
    ...
    // spl_autoload tự động load những class hướng đối tượng
    //cách 1:
    session_start();
...
<body>
      ...
      <div class="container">
          <div class="row">
              ...
              <?php
                $ctrl="home";
                // index dieu phoi den nhieu controller khac nhau thong qua bien action
                if(isset($_GET['action']))
                {
                  $ctrl=$_GET['action'];//$ctrl=sanpham
                }
